  ...
  plugins: [
    {
      ...
      options: {
        siteUrl: process.env.BASE_URL, // Used for sitemap generation
        manifestSettings: {
          favicon: "content/images/favicon.png", // Path is relative to the root
          siteName:
            "The professional homepage of John Ochs, software engineer & educator.", // Used in manifest.json
          shortName: "John Ochs • Home", // Used in manifest.json
